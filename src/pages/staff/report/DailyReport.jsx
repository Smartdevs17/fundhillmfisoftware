                          ...
                          <div className="row">
                            <div className="col-md-6 col-xl-3">
                              <div className="card-box tilebox-one">
                                ...
                                <span className="badge badge-success mr-1"> +11% </span> <span className="text-muted"><button type="button" className="btn btn-link waves-effect"><Link to="/staff/dashboard/regular_savings_report">See more</Link></button></span>
                              </div>
                            </div>
                            <div className="col-md-6 col-xl-3">
                              <div className="card-box tilebox-one">
                                ...
                                <span className="badge badge-success mr-1"> +11% </span> <span className="text-muted"><button type="button" className="btn btn-link waves-effect"><Link to="/staff/dashboard/targeted_savings_report">See more</Link></button></span>
                              </div>
                            </div>
                            <div className="col-md-6 col-xl-3">
                              <div className="card-box tilebox-one">
                            ...
                            <div className="col-md-6 col-xl-3">
                              <div className="card-box tilebox-one">
                                ...
                                <span className="badge badge-success mr-1"> +11% </span> <span className="text-muted"><button type="button" className="btn btn-link waves-effect"><Link to="/staff/dashboard/fixed_savings_report">See more</Link></button></span>
                              </div>
                            </div>
                            <div className="col-md-6 col-xl-3">
                              <div className="card-box tilebox-one">
